          ...
          <div class="container">
               <div class="row">
                    <div class="col-lg-3 pull-right col-xs-12">
                         ...
                         <ul class="list">
                              <li><a href="{{route('blog_detail')}}">Lorem ipsum dolor sit amet, consectetur adipisicing.</a></li>
                              <li><a href="{{route('blog_detail')}}">Et animi voluptatem, assumenda enim, consectetur quaerat!</a></li>
                              <li><a href="{{route('blog_detail')}}">Ducimus magni eveniet sit doloremque molestiae alias mollitia vitae.</a></li>
                         </ul>
                    </div>
                         ...
                         <div class="row">
                              <div class="col-sm-6">
                                   <div class="courses-thumb courses-thumb-secondary">
                                        ...
                                        <div class="courses-detail">
                                             <h3><a href="{{route('blog_detail')}}">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</a></h3>
                                        </div>

                                        <div class="courses-info">
                                             <a href="{{route('blog_detail')}}" class="section-btn btn btn-primary btn-block">Read More</a>
                                        </div>
                                   </div>
                              </div>
                              ...
                              <div class="col-sm-6">
                                   <div class="courses-thumb courses-thumb-secondary">
                                        ...
                                        <div class="courses-detail">
                                             <h3><a href="{{route('blog_detail')}}">Tempora molestiae, iste, consequatur unde sint praesentium!</a></h3>
                                        </div>
                              ...
                              <div class="col-sm-6">
                                   <div class="courses-thumb courses-thumb-secondary">
                                        ...
                                        <div class="courses-detail">
                                             <h3><a href="{{route('blog_detail')}}">A voluptas ratione, error provident distinctio, eaque id officia?</a></h3>
                                        </div>
