...
<div class="card1">
    ...
    <div class="" style="display: flex; justify-content:center; margin-top:30px">
        <div class="" style="border: 1px solid rgb(35, 117, 193); padding: 20px 50px 20px 50px; border-radius: 15px; background-color:rgb(12, 73, 130)">
            <a href="{{route('saleDay')}}" style="font-size: larger; font-weight:bolder; color:white">Xem ngày hôm nay</a>
        </div>
        <div class="" style="border: 1px solid rgb(35, 117, 193); padding: 20px 50px 20px 50px; border-radius: 15px; background-color:rgb(12, 73, 130)">
            <a href="{{route('findOrder')}}" style="font-size: larger; font-weight:bolder; color:white">Tìm kiếm đơn hàng</a>
        </div>
    </div>
</div>
@endsection
